...
//#include <C:\Users\m_oli\OneDrive\Documentos\Code block\Linguagem de Programa��o\menu.h>
...
void menu()
{
    ...
    default:
        system("clear");
        printf("OP��O INVALIDA , POR GENTILEZA DIGITE NOVAMENTE*\n");
...
void excluir (int i)
{
    ...
    for(i; i<cadastrados-1; i++)
    {
     ...
     cadastrados--;
    listar();
    printf("Corretista exclu�do com sucesso");
    printf("Voc� ser� redirecionado para o meunu principal...");
    system("pause");
    menu();
